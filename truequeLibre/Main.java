     ...
     * 	miUsuario.getTrueques().add(trueque1);
    	...
    	*/
    	...
    	item5 = new Item("Moto Yamaha", "La cambio por un Fiat 147", new ObjetoML(
    			...
    			"http://mla-s1-p.mlstatic.com/19567-MLA20173504975_102014-I.jpg", "mercadolibre"));
    	item6 = new Item("Camiseta Futbol Estudiantes", "La cambio por una camiseta de River", new ObjetoML(
    			...
    			"http://mla-s2-p.mlstatic.com/10850-MLA20035018254_012014-I.jpg", "mercadolibre"));
    	item7 = new Item("Musculosa Seleccion argentina", "La cambio por un PenDrive", new ObjetoML(
    			...
    			"http://mla-s1-p.mlstatic.com/9770-MLA20020656962_122013-I.jpg", "mercadolibre"));
    	item8 = new Item("Auto Fiat 147", "Lo cambio por una Moto", new ObjetoML(
    			...
    			"http://mla-s2-p.mlstatic.com/19762-MLA20176858358_102014-M.jpg", "mercadolibre"));
    	item9 = new Item("Auto Gol", "Lo cambio por un LCD 50 pulgadas", new ObjetoML(
    			...
    			"http://mla-s1-p.mlstatic.com/19619-MLA20175213019_102014-I.jpg", "mercadolibre"));

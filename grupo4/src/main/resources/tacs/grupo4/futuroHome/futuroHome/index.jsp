	...
	<div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="row">
            <div class="row"><h3>Mas Recientes</h3></div>
            ...
            <div class="row"><h3>Mas Consultados</h3></div>
            <div class="col-6 col-sm-6 col-lg-4">
        ...
        <div><h4>Articulos</h4></div>
          <div class="list-group">
            <a href="#" class="list-group-item active">Computacion</a>
            <a href="#" class="list-group-item">Deco</a>
            <a href="#" class="list-group-item">Celulares</a>
            <a href="#" class="list-group-item">Indumentaria</a>
